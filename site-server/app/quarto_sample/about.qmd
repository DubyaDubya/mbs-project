...
To run this analysis, data needed to be integrated from the Federal Reserve's Open Market API, Fannie Mae's issuance files and Freddie Mae's Issuance files
